...
namespace Jump {
    ...
    /// \brief Supplies easy random number generation capabilities, with a
    /// templated type for the random numbers and underlying distribution.
    ...
    class RandomNumbers {
        ...
        public:
            ...
            /// generate random numbers from the templated distribution,
            /// forwarding whatever arguments are needed.
