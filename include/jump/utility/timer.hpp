...
namespace Jump {
    ...
    class Timer {
        private:
            ...
            /// running since its creation.
            Clock::duration m_delta_t {Clock::duration::zero()};
            /// \brief String storing a description of the task being timed.
            std::string m_task;

            /// \brief Returns the time in a formatted string appropriate for
            /// the time duration supplied.
        ...
        public:
            ...
            void start();
            /// \brief Stop the current timing session if it running, otherwise
            /// do nothing. Add the new duration to the running total.
            void stop();
            ...
            /// \brief Return the total elapsed time of the timing sessions in
            /// the format provided by formatted_time.
            ...
            /// \brief Return the average time of completed timing sessions in
            /// the format provided by formatted_time.
