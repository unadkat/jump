...
namespace Jump {
    ...
    /// \brief Data for Range2DError, including name, access indices, and size
    /// of 2D container.
    struct Range2DError {
    ...
    /// \brief Data for Mismatch2DError, including names, acess indices, and
    /// sizes of 2D containers.
